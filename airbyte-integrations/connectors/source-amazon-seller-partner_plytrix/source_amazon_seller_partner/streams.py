...
class FulfilledShipmentsReports(ReportsAmazonSPStream):
    ...
    def _report_data(
        ...
        #replication_start_date = pendulum.parse(d)

        data = {
            "reportType": self.name,
            "marketplaceIds": [self.marketplace_id],
            "dataStartTime": d.strftime(DATE_TIME_FORMAT),
        }
        return data
...
class FbaReturnsByReturnDateIncremental(IncrementalReportsAmazonSPStream):
    """
    Field definitions: https://sellercentral.amazon.com/gp/help/help.html?itemID=201648780
    """

    name = "GET_FLAT_FILE_RETURNS_DATA_BY_RETURN_DATE"
    cursor_field = "return-date"

class FbaReiumbursementReports(ReportsAmazonSPStream):
    """
    Field definitions: https://sellercentral.amazon.com/gp/help/200740930
    """
